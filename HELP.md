...
* The original package name 'com.tse.archi-n-tiers.photoEntity-sharing' is invalid and this project uses 'com.tse.archintiers.photosharing' instead.
...
* [Create an OCI photoEntity](https://docs.spring.io/spring-boot/docs/2.6.1/gradle-plugin/reference/html/#build-photoEntity)
